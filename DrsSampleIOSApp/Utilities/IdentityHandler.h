...
/**
 * IdentityHandler class is used to authorize an application with the LoginWithAmazon framework.
 * This class demonstrates how to properly use LWA framework and how to obtain the access and refresh token.
 * For more information please refer to
 * https://developer.amazon.com/public/solutions/devices/dash-replenishment-service/docs/dash-lwa-mobile-sdk.
 */
@interface IdentityHandler : NSObject

/**
 * Initialize an identity handler object with a DrsDeviceProtocol handler object and CodeChallengeGenerator generator.
 * @param drsHandler The object which implements DrsDeviceProtocol protocol.
 * @param generator The CodeChallengeGenerator generator.
...
/**
 * Login with Amazon and authorize the app.
 */
- (void)login;

/**
 * Logout. Deletes cached user tokens and other data.
 */
- (void)logout;

/**
 * Request the new access token with the refresh token.
