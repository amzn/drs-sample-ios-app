...
/**
 * TokenGenerator is used inside the IdentityHandler to obtain the access and refresh token.
 */
@interface TokenGenerator : NSObject

/**
 * Initialize a token generator object with a DrsDeviceProtocol handler object,
 * client ID, LWA access code and redirect URL.
 * @param drsHandler The DrsDeviceProtocol handler.
 * @param clientID The NSString client ID.
 * @param lwaAccessCode The NSString lwa access code.
 * @param redirectUri The NSString redirect uri.
 * @return The instance of the TokenGenerator.
 */
 ...
 * @param drsHandler The DrsDeviceProtocol handler.
 * @param clientID The NSString client ID.
 * @param refreshToken The NSString refresh token.
 * @return The instance of the TokenGenerator.
 */
- (instancetype)initWithDrsHandler:(id <DrsDeviceProtocol>)drsHandler
                          clientID:(NSString *)clientID
...
/**
 * Request the new access and refresh token.
 * First time login.
 */
 ...
 * You must have a refresh token to perform this operation.
 */
