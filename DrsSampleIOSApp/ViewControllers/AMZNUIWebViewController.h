...
/**
 * AMZNUIWebViewController class used to display web pages and to intercept the user interaction with them.
 */
@interface AMZNUIWebViewController : UIViewController

/**
 * The UIWebView used to load the web page.
 */
...
/**
 * Intercepts users clicks on "Get started" link and proceed to the main view controller.
 */
- (void)loginUser;

/**
 * Load the web page from a local HTML file.
 * @param path The NSString page path of the file.
 */
