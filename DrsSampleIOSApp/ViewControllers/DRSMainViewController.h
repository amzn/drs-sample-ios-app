...
#import "DrsDeviceProtocol.h"
#import "BaseViewController.h"

/**
 * Main view controller. Displays all the actions that are available to a user and results of those actions.
 * Demonstrate a simple implementation of DrsDeviceProtocol.
 */
@interface DRSMainViewController : BaseViewController <UITextFieldDelegate, DrsDeviceProtocol, UIPickerViewDelegate, UIPickerViewDataSource>
...
/**
 * The access token editable text field.
 */
@property(weak, nonatomic) IBOutlet UITextField *accessTokenTextField;

/**
 * The refresh token editable text field.
 */
@property(weak, nonatomic) IBOutlet UITextField *refreshTokenTextField;

/**
 * The slot ID editable text field.
 */
@property(weak, nonatomic) IBOutlet UITextField *slotIDTextField;

/**
 * The device model UILabel.
 */
@property(weak, nonatomic) IBOutlet UILabel *deviceModelLabel;

/**
 * The device serial number UILabel.
 */
@property(weak, nonatomic) IBOutlet UILabel *deviceSerialLabel;

/**
 * The UITextView used for displaying an API outputs.
 */
...
/*
 * Whether or not to include non-live devices.
 */
@property(weak, nonatomic) IBOutlet UISwitch *includeNonLiveDevicesSwitch;
