...
/**
 * Base view controller class. Contains common logic for all controllers.
 */
@interface BaseViewController : UIViewController

/**
 * Get the getAMAZNUIWebViewController.
 * @param url The NSURL to be loaded in the controller.
 * @return The AMZNUIWebViewController.
 */
- (AMZNUIWebViewController *)getAMAZNUIWebViewControllerWithUrl:(NSURL *)url;
