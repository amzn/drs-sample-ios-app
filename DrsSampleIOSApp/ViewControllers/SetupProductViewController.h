...
/**
 * Allows the user to enter the device model and serial number.
 */
@interface SetupProductViewController : BaseViewController

/**
 * The Device model UITextField.
 */
@property(weak, nonatomic) IBOutlet UITextField *deviceModelTextField;

/**
 * The device serial number UITexField. 
 */
@property(weak, nonatomic) IBOutlet UITextField *deviceSerialTextField;

/**
 * The composite ID UITextField.
 */
@property(weak, nonatomic) IBOutlet UITextField *compositeIDTextField;

/**
 * The UISwitch that indicates is this a test device or not.
 */
@property(weak, nonatomic) IBOutlet UISwitch *isTestDevice;

/*
 * The UISwitch that indicates if we should include non-live devices.
 */
