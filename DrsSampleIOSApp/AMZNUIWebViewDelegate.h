...
/**
 * AMZNUIWebViewDelegate class implements UIWebViewDelegate protocol to intercept a user interaction with a web page.
 * If a user clicks on certain links, it will get redirected on a proper custom page.
 */
@class AMZNUIWebViewController;

@interface AMZNUIWebViewDelegate : NSObject <UIWebViewDelegate>

/**
 * Initialize an AMZNUIWebViewDelegate with an AMZNUIWebViewController object.
 */
